...
В этом репозитории вы можете найти некоторые из моих проектов, над которыми мне довелось поработать. Помимо проектов могу также поделиться отзывами о моих  работах
<br>
...
> <a href="Рисунок1.png"> ТЗ, присланное заказчиком можно увидеть тут </a>
