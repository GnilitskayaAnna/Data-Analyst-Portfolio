...
<ol>
	<li> Задача №1. Анализ основных бизнесс-метрик онлайн-кинотеатра при помощи генерации сводных таблиц </li>	
...
<li> С результатом анализа метрик посредством сводных таблиц можно ознакомиться </li>
	> <a href=""> здесь </a>


 
        <li>  Задача №2.Рассчёт бизнесс-метрик для калькулятора юнит-экономики </li>	
<li> В рамках Задачи № 2: рассчитывались следующие метрики :</li>
