...
<p> Выводы (итоги):<p>
	...
	В ходе выполнения перечисленных задач была произведена оценка эффективности текущей бизнесс-модели  на основе  нескольких закономерностей
1) Retention. Этот параметр показал неуклонное снижение
2) Средний CAC. Его высокие значения говорят о малой эффективности маркетинговых вложений
3) Маржинальность. Этот показатель принял значение в - 93,8%

   Все перечисленные закономерности свидетельствуют о крайней неэффективности текущей бизнесс-модели. Исходя из этого была разработана и предложена альтернативная бизнесс-модель. 
  <p> Основные предложения альтернативной бизнесс-модели:<p>
